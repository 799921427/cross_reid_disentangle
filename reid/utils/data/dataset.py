        ...
        for camid, cam_images in enumerate(pid_images):
            for fname in cam_images:
                ...
                if relabel:
                    ...
                    if 'fake' in fname: continue
                    else: ret.append((fname, pid, camid))
    return ret
    ...
    # --------------------------------------------------------  #
        ...
        for image in self.trainval:
            ...
            if image[2] == 2 or image[2] == 5:
                ...
                countRGB = countRGB + 1
        self.query = _pluck(identities, self.split['query'], relabel=False)
        self.gallery = _pluck(identities, self.split['gallery'], relabel=False)
        query = 0
        gallery = 0
