...
def get_all_data_loaders(conf):
    ...
    if 'data_root' in conf:
        train_loader_a = get_data_loader_folder(os.path.join(conf['data_root'], 'train'), batch_size, True,
        ...
        train_loader_b = get_data_loader_folder(os.path.join(conf['data_root'], 'train'), batch_size, True,
